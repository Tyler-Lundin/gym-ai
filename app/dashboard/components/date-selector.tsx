...
export default function DateSelector() {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={toggle}
        className="top-0 p-2 text-lg font-black text-center rounded-b-md border-b w-fit bg-black/50 backdrop-blur-sm border-x h-min text-blue-250 dark:border-white/25"
      >
